        ...
        <div className="relative min-h-screen bg-dark-bg selection:bg-brand selection:text-black">
            ...
            <header className="fixed top-0 left-0 right-0 z-50 max-w-7xl mx-auto w-full border-x border-b border-dark-border bg-black h-16 flex items-center justify-between px-4 sm:px-6 lg:px-8 select-none">
                ...
                <div className="flex items-center gap-3">
                    <Link
                        to="/"
                        className="hidden sm:flex items-center gap-1 px-3 py-1.5 text-[11px] font-mono text-white hover:text-gray-400 transition-colors"
                    >
            ...
            {/* Hero */}
            <section className="relative w-full overflow-hidden border-b border-dark-border text-center bg-blue-100 select-none">
                <div className="relative z-10 max-w-7xl mx-auto border-x border-dark-border bg-[#F9F6EE] px-4 sm:px-6 lg:px-8 py-16 md:py-24 flex flex-col items-center justify-center min-h-[78vh]">
                    <NetworkBackground />

                    <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        <div className="inline-flex items-center space-x-2 px-3 py-1 text-black text-[10px] uppercase font-mono tracking-widest shadow-xl shadow-brand/5">
                    ...
                    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center gap-3 z-20">
                        ...
                        <div className="inline-flex items-center space-x-2 text-[10px] font-mono text-black uppercase tracking-widest">
                            <span className="relative flex h-2 w-2">
                                <span className="animate-ping absolute inline-flex h-full w-full bg-brand-green opacity-75" />
            ...
            {/* The premise */}
            <section className="relative w-full border-b border-dark-border bg-purple-100">
            ...
            <section id="terms" className="w-full border-b border-dark-border bg-green-100">
                <div className="max-w-7xl mx-auto border-x border-dark-border bg-[#F9F6EE] px-4 sm:px-6 lg:px-8 py-20 md:py-28">
                        ...
                        {ownership.map((item, i) => {
                            ...
                            return (
                                <Reveal key={item.title} delay={i * 0.08}>
                                    <div className="group h-full p-6 border border-dark-border bg-dark-card hover:border-gray-400 transition-colors duration-200">
            ...
            {/* What we expect */}
            <section className="w-full border-b border-dark-border bg-orange-100">
                <div className="max-w-7xl mx-auto border-x border-dark-border bg-[#F9F6EE] px-4 sm:px-6 lg:px-8 py-20 md:py-28">
                        ...
                        <div className="space-y-3">
                            {expectations.map((line, i) => (
                                <Reveal key={i} delay={i * 0.06}>
                                    <div className="flex items-start gap-3 p-4 border border-dark-border bg-dark-card hover:border-gray-400 transition-colors">
            ...
            <section className="w-full border-b border-dark-border bg-pink-100">
                <div className="max-w-7xl mx-auto border-x border-dark-border bg-[#F9F6EE] px-4 sm:px-6 lg:px-8 py-20 md:py-28">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {lookingFor.map((line, i) => (
                            <Reveal key={i} delay={i * 0.07}>
                                <div className="flex items-start gap-3 p-5 border border-dark-border bg-dark-card hover:border-gray-400 transition-colors h-full">
            ...
            <section className="w-full border-b border-dark-border bg-blue-100">
                <div className="max-w-7xl mx-auto border-x border-dark-border bg-[#F9F6EE] px-4 sm:px-6 lg:px-8 py-20 md:py-28">
                    <div className="max-w-3xl mx-auto">
                        <Reveal>
                        ...
                        <div className="mt-8 space-y-4">
                            <Reveal delay={0.05}>
                                <div className="flex items-start gap-4 p-5 border border-dark-border hover:border-gray-400 bg-dark-card">
                                    <div>
            ...
            {/* FAQ */}
            <section className="border-b border-dark-border bg-green-100">
                <div className="max-w-7xl mx-auto border-x border-dark-border bg-[#F9F6EE] px-4 sm:px-6 lg:px-8 py-20 md:py-28">
                    <div className="max-w-3xl mx-auto">
                        ...
                        <div className="space-y-3">
                            {faqs.map((faq, i) => (
                                <Reveal key={i} delay={i * 0.05}>
                                    <div className="-xl border border-dark-border bg-dark-card hover:border-gray-400 overflow-hidden">
                                        <button
                                        ...
                                        >
                                            ...
                                            <ChevronDown
                                                className={`w-4 h-4 text-black shrink-0 transition-transform duration-200 ${openFaq === i ? 'rotate-180' : ''
                                                    }`}
                                            />
                                        </button>
                                        <motion.div
            ...
            {/* Apply CTA */}
            <section id="apply" className="relative w-full overflow-hidden text-center bg-yellow-100">
