        ...
        <div className="relative min-h-screen bg-dark-bg selection:bg-brand selection:text-black">
            ...
            <header className="sticky top-0 z-40 w-full border-b border-dark-border bg-dark-bg/85 backdrop-blur-md select-none">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                    <Link to="/" className="flex items-center space-x-2 cursor-pointer group">
                        <div className="p-1 -sm bg-brand/10 border border-brand/20 group-hover:border-gray-400/40 group-hover:bg-brand/20 transition-all duration-300">
                            <ShieldCheck className="w-5 h-5 text-brand" />
                        </div>
                        <span className="font-display font-bold text-black tracking-tight text-lg group-hover:text-brand transition-colors">
                    ...
                    <div className="flex items-center gap-3">
                        <Link
                            to="/"
                            className="hidden sm:flex items-center gap-1 px-3 py-1.5 -lg text-[11px] font-mono text-black hover:text-black transition-colors"
                        >
                        ...
                        <a
                            href="#apply"
                            className="px-4 py-1.5 -lg bg-brand hover:bg-brand/90 text-[11px] font-mono font-medium text-black shadow-xs transition-all duration-300 active:scale-[0.98]"
                        >
                            Apply to join
                        </a>
                    </div>
            ...
            <section className="relative min-h-[78vh] flex items-center justify-center overflow-hidden py-16 md:py-24 border-b border-dark-border select-none">
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div className="inline-flex items-center space-x-2 bg-brand/5 border border-brand/20 px-3 py-1 -full text-brand text-[10px] uppercase font-mono tracking-widest shadow-xl shadow-brand/5">
                    ...
                    <div className="mt-8 inline-flex items-center space-x-2 text-[10px] font-mono text-black uppercase tracking-widest">
                        <span className="relative flex h-2 w-2">
                            <span className="animate-ping absolute inline-flex h-full w-full -full bg-brand-green opacity-75" />
                            <span className="relative inline-flex -full h-2 w-2 bg-brand-green" />
                        </span>
            ...
            <section className="relative bg-[#08080A]/40 border-b border-dark-border">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
                    <Reveal>
                        ...
                        <p className="text-sm sm:text-base text-black leading-relaxed mt-5">
                        ...
                        <p className="text-sm sm:text-base text-black leading-relaxed mt-4">
            ...
            <section id="terms" className="border-b border-dark-border">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
                        ...
                        {ownership.map((item, i) => {
                            ...
                            return (
                                <Reveal key={item.title} delay={i * 0.08}>
                                    <div className="group h-full p-6 -xl border border-dark-border bg-dark-card hover:border-gray-400/40 transition-colors duration-300">
                                        <div className="flex items-center gap-3 mb-4">
                                            <div className="p-2 -lg bg-brand/10 border border-brand/20 group-hover:bg-brand/20 transition-colors">
                                                <Icon className="w-5 h-5 text-brand" />
                                            </div>
                                            <h3 className="font-display font-bold text-black text-lg tracking-tight">
                                                {item.title}
                                            </h3>
                                        </div>
                                        <p className="text-sm text-black leading-relaxed">{item.body}</p>
                                    </div>
                                </Reveal>
                            );
                        })}
                    ...
                    <Reveal delay={0.1}>
                        <p className="text-center text-sm text-black font-mono mt-10 max-w-2xl mx-auto leading-relaxed">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        <Reveal>
                            ...
                            <p className="text-sm text-black leading-relaxed mt-4 max-w-md">
                        ...
                        <div className="space-y-3">
                            {expectations.map((line, i) => (
                                <Reveal key={i} delay={i * 0.06}>
                                    <div className="flex items-start gap-3 p-4 -xl border border-dark-border bg-dark-card hover:border-gray-400/40 transition-colors">
                                        <Check className="w-4 h-4 text-brand-green mt-0.5 shrink-0" />
                                        <span className="text-sm text-black leading-relaxed">{line}</span>
                                    </div>
                                </Reveal>
                            ))}
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {lookingFor.map((line, i) => (
                            <Reveal key={i} delay={i * 0.07}>
                                <div className="flex items-start gap-3 p-5 -xl border border-dark-border bg-dark-card hover:border-gray-400/40 transition-colors h-full">
            ...
            <section className="bg-[#08080A]/40 border-b border-dark-border">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
                    ...
                    <div className="mt-8 space-y-4">
                        <Reveal delay={0.05}>
                            <div className="flex items-start gap-4 p-5 -xl border border-dark-border bg-dark-card">
                                <div className="p-2 -lg bg-brand/10 border border-brand/20">
                                    <PieChart className="w-5 h-5 text-brand" />
                                </div>
                                <div>
                                    <h3 className="font-display font-bold text-black tracking-tight">Ownership</h3>
                        ...
                        <Reveal delay={0.1}>
                            <div className="flex items-start gap-4 p-5 -xl border border-dark-border bg-dark-card">
                                ...
                                <div>
                                    <h3 className="font-display font-bold text-black tracking-tight">Treasury</h3>
                                    <p className="text-sm text-black leading-relaxed mt-1">
                        ...
                        <Reveal delay={0.15}>
                            <div className="flex items-start gap-4 p-5 -xl border border-dark-border bg-dark-card">
                                ...
                                <div>
                                    <h3 className="font-display font-bold text-black tracking-tight">Decisions</h3>
                                    <p className="text-sm text-black leading-relaxed mt-1">
                    ...
                    <div className="space-y-3">
                        {faqs.map((faq, i) => (
                            <Reveal key={i} delay={i * 0.05}>
                                <div className="-xl border border-dark-border bg-dark-card overflow-hidden">
                                    <button
                                        onClick={() => setOpenFaq(openFaq === i ? null : i)}
                                        className="w-full flex items-center justify-between gap-4 px-5 py-4 text-left hover:bg-brand/5 transition-colors"
                                    >
                                        <span className="font-display font-semibold text-black text-sm sm:text-base">
                                            {faq.q}
                                        </span>
                                        <ChevronDown
                                    ...
                                    >
                                        <p className="px-5 pb-4 text-sm text-black leading-relaxed">{faq.a}</p>
                                    </motion.div>
                                </div>
                            </Reveal>
                        ))}
            ...
            <section id="apply" className="relative py-24 md:py-32 overflow-hidden border-b border-dark-border text-center">
                ...
                <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
                    <Reveal>
                        ...
                        <p className="text-sm sm:text-base text-black max-w-md mx-auto leading-relaxed mt-5">
                    ...
                    <Reveal delay={0.1}>
                        <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
                            <a
                                ...
                                className="w-full sm:w-auto px-8 py-3.5 -lg bg-brand hover:bg-brand/90 hover:shadow-lg hover:shadow-brand/20 font-mono text-xs uppercase tracking-widest text-black shadow-md active:scale-[0.98] transition-all duration-300 cursor-pointer inline-flex items-center justify-center gap-2"
                            >
                            ...
                            <a
                                ...
                                className="w-full sm:w-auto px-8 py-3.5 -lg bg-dark-bg border border-dark-border hover:border-gray-400/40 text-black hover:text-black font-mono text-xs uppercase tracking-widest active:scale-[0.98] transition-all duration-300 cursor-pointer inline-flex items-center justify-center gap-2"
                            >
                                GitHub
            ...
            {/* Footer - same as home */}
            <footer className="bg-[#050507] text-black font-sans select-none border-t border-dark-border/40">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 flex flex-col md:flex-row items-center justify-between gap-6">
                    <Link to="/" className="flex items-center space-x-2">
                        <div className="p-1 -sm bg-brand/10 border border-brand/20">
                    ...
                    <div className="flex flex-wrap justify-center gap-6 font-mono text-xs text-black">
                        <a href="https://github.com/Evice-labs" target="_blank" rel="noopener noreferrer" className="hover:text-black transition-colors flex items-center space-x-1">
                            <span>GitHub</span>
                            <ArrowUpRight className="w-3 h-3 text-black" />
                        </a>
                        <a href="https://x.com/Evice_labs" target="_blank" rel="noopener noreferrer" className="hover:text-black transition-colors flex items-center space-x-1">
                            <span>X / Twitter</span>
                            <ArrowUpRight className="w-3 h-3 text-black" />
                        </a>
                        <a href="mailto:hello@evice.dev" className="hover:text-black transition-colors flex items-center space-x-1">
                            <span>Email</span>
